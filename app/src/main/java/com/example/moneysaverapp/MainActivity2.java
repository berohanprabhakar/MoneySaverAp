...
public class MainActivity2 extends AppCompatActivity {
    private CardView budgetCard,TodayCard,weekCardview,monthCardview,analyticsCardView,historyCardView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("MoneySaver App");
        ...
        budgetCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(MainActivity2.this,BudgetActivity.class);
        ...
        TodayCard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(MainActivity2.this,TodaySpendingActivity.class);
                startActivity(intent);
            }
        });
        weekCardview.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(MainActivity2.this,WeekSpendingActivity.class);
        ...
        analyticsCardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(MainActivity2.this,ChooseAnalyticActivity.class);
        ...
        budgetRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists() && snapshot.getChildrenCount()>0){
                    ...
                    Toast.makeText(MainActivity2.this, "Please Set a BUDGET ", Toast.LENGTH_LONG).show();
                }
